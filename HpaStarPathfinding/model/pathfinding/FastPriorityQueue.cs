...
public sealed class FastPriorityQueue<T>
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool Contains(PathfindingCell node) => _nodes[node.QueueIndex] == node;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Remove(PathfindingCell node) {
        //If the node is already the last node, we can remove it immediately
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static bool HasHigherPriority(PathfindingCell higher, PathfindingCell lower) => higher.FCost < lower.FCost;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static bool HasHigherOrEqualPriority(PathfindingCell higher, PathfindingCell lower) => higher.FCost <= lower.FCost;
